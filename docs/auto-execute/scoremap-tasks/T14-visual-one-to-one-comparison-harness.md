...
## 实现功能
建立从 UI PNG 和 Stitch screen.png 到本地页面截图的 capture+pixelmatch 或等价比较；每个 P0 页面输出 reference、actual、diff、metrics、summary。
...
## 允许改动范围
tools/ui-visual/**, docs/auto-execute/evidence/visual/**
...
## 验收标准
- 当前任务主验收面 visual-harness 已实现或已验证。
...
- docs/auto-execute/evidence/visual-harness/
