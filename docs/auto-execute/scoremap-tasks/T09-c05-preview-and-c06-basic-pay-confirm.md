...
## 实现功能
按 分析报告.png、1元支付.png 与 Stitch 1 复刻预览、锁定区、1 元确认页；按钮文案必须是完整初判，不得写完整报告。
...
## 允许改动范围
scoremap-miniapp/pages/preview/**, scoremap-miniapp/pages/basic-pay/**
...
必跑命令：
~~~powershell
npm test -- preview-basic-pay; npm run visual:scoremap -- preview basic-pay
~~~
