...
## 实现功能
按 AI分析.png、处理失败.png 与 Stitch ai_1/_3 复刻进度页和失败页；实现 2 秒轮询、30 秒超时、稍后查看、刷新、失败恢复按钮。
...
## 允许改动范围
scoremap-miniapp/pages/analysis/**, scoremap-miniapp/pages/failure/**, docs/auto-execute/evidence/**
...
必跑命令：
~~~powershell
npm test -- analysis-failure; npm run visual:scoremap -- analysis failure
~~~
