...
## 实现功能
建立 docs/auto-execute/latest、results、evidence 目录；读取 PRD、UI、Stitch、参考项目；产出源文档清单、缺口清单、验收状态枚举、结果 JSON schema、报告完整性检查脚本。
...
## 允许改动范围
docs/auto-execute/**, scripts/acceptance/**
...
## 验收标准
- 当前任务主验收面 documentation+harness 已实现或已验证。
