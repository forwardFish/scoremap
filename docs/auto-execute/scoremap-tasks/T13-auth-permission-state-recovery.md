...
## 实现功能
校验 order owner、access_level、支付状态、报告生成状态；未登录/匿名绑定；支付成功页面关闭后的恢复；401/404/500/timeout 错误处理。
...
## 允许改动范围
server/src/middleware/**, server/src/services/**, scoremap-miniapp/services/**, server/test/**
...
## 验收标准
- 当前任务主验收面 contract-security 已实现或已验证。
...
- docs/auto-execute/evidence/contract-security/
