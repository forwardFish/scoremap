...
## 实现功能
实现 POST /api/diagnosis-orders、POST /api/diagnosis-orders/{orderId}/uploads、POST /start-preview-analysis、GET /analysis-progress、GET /preview-decision，含低质图片、超时、失败枚举。
...
## 允许改动范围
server/src/routes/**, server/src/services/**, server/test/**
...
- docs/auto-execute/evidence/backend-api/
