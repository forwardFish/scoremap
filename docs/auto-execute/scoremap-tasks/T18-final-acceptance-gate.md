...
## 实现功能
读取全部 results/*.json、owner matrix、visual summary、API/DB evidence、secret guard、report integrity；只允许证据齐全时 PASS，否则输出 REPAIR_REQUIRED/PASS_WITH_LIMITATION。
...
## 允许改动范围
scripts/acceptance/run-final-gate.ps1, docs/auto-execute/final/**
...
- docs/auto-execute/evidence/final-gate/
