...
## 实现功能
证明腾讯云、微信支付、线上 DB 未被调用；secret guard 扫描 env、源码、日志；生产域名/密钥/云 SDK 调用必须失败关闭或 mock。
...
## 允许改动范围
scripts/acceptance/**, docs/auto-execute/evidence/safety/**
