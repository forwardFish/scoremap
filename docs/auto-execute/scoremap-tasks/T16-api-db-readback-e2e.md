...
## 实现功能
覆盖所有 API 的 2xx/4xx/5xx/timeout、本地 DB mutation/readback、导出字段；输出 API trace、DB snapshot、断言 JSON。
...
## 允许改动范围
tests/api/**, server/test/**, docs/auto-execute/evidence/api-db/**
...
- docs/auto-execute/evidence/api-db-e2e/
