...
## 实现功能
实现家长从首页上传、授权、分析、1 元解锁、9.9 解锁、保存、我的报告复看、反馈、失败恢复的点击 E2E；记录每步 route、API、DB、截图。
...
## 允许改动范围
tests/e2e/**, docs/auto-execute/evidence/owner/**
...
- docs/auto-execute/evidence/e2e-owner/
