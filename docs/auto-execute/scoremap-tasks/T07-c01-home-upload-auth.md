...
## 实现功能
按 首页.png 与 Stitch ai_2 复刻首页；实现上传资料、授权确认、创建订单、最近报告、查看样例、我的报告入口、底部 Tab。
...
## 允许改动范围
scoremap-miniapp/pages/index/**, scoremap-miniapp/components/**, docs/auto-execute/evidence/**
...
必跑命令：
~~~powershell
npm test -- home-upload; npm run visual:scoremap -- home
~~~
