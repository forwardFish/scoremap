# Task T11 - C09 完整提分报告入口与 C10 PDF 式报告
...
## 实现功能
按完整提分报告.png、完整报告.png 与 Stitch _2/ai_pdf 复刻入口与纸质报告；若展示下载 PDF 必须真实生成本地 PDF，否则隐藏按钮。
...
## 允许改动范围
scoremap-miniapp/pages/full-report-entry/**, scoremap-miniapp/pages/full-report/**, server/src/report/**
...
## 验收标准
- 当前任务主验收面 frontend-page 已实现或已验证。
...
必跑命令：
~~~powershell
npm test -- full-report-pdf; npm run visual:scoremap -- full-report-entry full-report
~~~

证据输出：
- docs/auto-execute/results/T11.json
- docs/auto-execute/latest/T11-HANDOFF.md
- docs/auto-execute/evidence/frontend-page/
