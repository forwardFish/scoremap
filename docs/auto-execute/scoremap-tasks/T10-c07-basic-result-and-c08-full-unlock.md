# Task T10 - C07 AI 初判结果与 C08 解锁完整分析
...
## 实现功能
按完整初判结果、解锁完整分析 Stitch _4 复刻；展示 basic decision 字段、9.9 升级权益、合规文案、支付入口。
...
## 允许改动范围
scoremap-miniapp/pages/basic-result/**, scoremap-miniapp/pages/full-unlock/**
...
必跑命令：
~~~powershell
npm test -- basic-result-full-unlock; npm run visual:scoremap -- basic-result full-unlock
~~~
