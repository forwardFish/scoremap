...
## 实现功能
实现 GET /basic-decision、POST /generate-full、GET /full-report、POST /save-report、GET /my/reports、POST /feedback、POST /export-pdf、GET /report-exports/{id}、运营导出脚本。
...
## 允许改动范围
server/src/routes/**, server/src/services/**, server/scripts/**, server/test/**
...
## 验收标准
- 当前任务主验收面 backend-api-report 已实现或已验证。
...
- docs/auto-execute/evidence/backend-api-report/
