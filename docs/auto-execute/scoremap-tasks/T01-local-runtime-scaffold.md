...
## 实现功能
创建 scoremap-miniapp、server、shared 或等价结构；提供本地启动、测试、fixture、env.example；默认 LOCAL_ONLY=true；不得引入真实云密钥。
...
## 允许改动范围
package.json, scoremap-miniapp/**, server/**, shared/**, scripts/**
...
- docs/auto-execute/evidence/scaffold/
