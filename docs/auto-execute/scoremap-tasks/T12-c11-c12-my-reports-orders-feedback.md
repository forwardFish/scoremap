...
## 实现功能
按 我的.png 与 Stitch _1 复刻我的页；实现我的报告、订单记录、购买记录、帮助反馈、继续新建分析；Pro 仅作权益占位。
...
## 允许改动范围
scoremap-miniapp/pages/my/**, scoremap-miniapp/pages/reports/**, scoremap-miniapp/pages/orders/**, scoremap-miniapp/pages/feedback/**
...
必跑命令：
~~~powershell
npm test -- my-reports-feedback; npm run visual:scoremap -- my reports
~~~
