if (typeof Page === 'function') {
  ...
  createReplicaPage({
  "title": "确认 1 元初判",
  "reference": "/assets/reference/basic-pay.jpg",
  "derived": false,
  "hotspots": [
    {
      "action": "pay",
...
function createBasicPayPageState(client = createMiniappApiClient(), options = {}) {
  ...
  const page = {
    ...
    orderId,
    uiReference: {
      png: 'docs/UI/小程序/1元支付.png',
      stitch: 'docs/UI/小程序/stitch_codex_development_blueprints/1/screen.png'
    },
    title: '确认 1 元初判',
